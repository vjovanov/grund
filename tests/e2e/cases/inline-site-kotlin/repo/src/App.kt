...
// This is a plain slash run directly above a definition, which Kotlin does not
...
// Only a block comment opened with a doc marker is a KDoc here.
fun rounded(amount: Int): Int {
    val step = 5
