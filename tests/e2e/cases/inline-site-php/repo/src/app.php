...
// This is a plain slash run directly above a definition, which PHP does not
...
// Only a block comment opened with a doc marker is a PHPDoc here.
function rounded(int $amount): int
{
    $step = 5;
