...
- `embedded_value_source_forms.rs` — every promised line, block-doc, and Python docstring wrapper roots a value and reaches mismatch comparison ([§AR-scanner.2.2](../../docs/architecture/AR-scanner.md#22-section-detection), [§AR-checker.2.18](../../crates/grund-core/src/checker.rs#L235-L242)).
