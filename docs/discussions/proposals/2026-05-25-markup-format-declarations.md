...
## 4. Two homes per format

### 4.1. Home A — the declaration is a comment (cheap, invisible)
...
### 4.2. Home B — the declaration is a native rendered heading (the goal)
...
### 5.1. AsciiDoc — the clean case (marker-count levels)
...
### 5.2. reStructuredText — the hard case (order-dependent levels)
...
### 5.3. LaTeX — the middle case (keyword-hierarchy levels)
...
### 5.4. Org-mode and Typst — same axis, noted for completeness
